...
import { FaFile, FaCloudDownloadAlt } from 'react-icons/fa';
...
export class FileMessage extends Component {
    ...
    onClick(e) {
        ...
        if (!this.props.data.status.download && this.props.onDownload instanceof Function)
            this.props.onDownload(e, this.props.data);
        else if (this.props.data.status.download && this.props.data.onClick instanceof Function)
            this.props.data.onClick(e, this.props.data);
    }
